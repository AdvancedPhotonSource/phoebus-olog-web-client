...
class Attachment extends Component{
    ...
    render(){
        if(this.props.file) {
            ...
            if (this.props.type.toLowerCase().startsWith("image")) {
                let url = `attachment/${this.props.id}`;
                return(
                    <div className="attachment">
                        <a download={this.props.filename} href={url} title={this.props.filename}>
                            <Image src={url} className="attachment"/>
